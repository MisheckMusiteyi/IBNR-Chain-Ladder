...
<div class="hero">
    ...
    <p>Upload your claims data (CSV). Select the currency columns for which you want the IBNR Breakdown. The app will compute IBNR and Ultimate claims by product using the Chain Ladder method.</p>
</div>
""", unsafe_allow_html=True)
...
# File uploader
uploaded_file = st.file_uploader("Upload a CSV file with the claims data", type="csv")
