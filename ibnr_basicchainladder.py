...
# ---------- Header (logo removed, only nav links) ----------
st.markdown("""
<div class="header">
    <div class="nav-links">
        <a href="#">Home</a>
...
<div class="hero">
    ...
    <p>Upload your claims data (CSV). Select the currency columns you want to analyse. The app will compute IBNR and Ultimate claims by product using the Chain Ladder method.</p>
</div>
""", unsafe_allow_html=True)
...
# File uploader
uploaded_file = st.file_uploader("Choose a CSV file with loss data", type="csv")
...
<div class="footer">
    ...
    <p style="margin-top: 0.5rem; font-size: 0.9rem;">Powered by Streamlit & Chainladder</p>
</div>
""", unsafe_allow_html=True)
